const translations = {
  ...
  studio_about_manifesto_eyebrow: '宣言',
  studio_team_strip_eyebrow: '认识团队',
  studio_team_heading1: '认识塑造',
  studio_team_heading2: '团队成员',
  ...
  studio_process_design_title: '设计与文件',
  studio_process_design_desc: '所选概念在所有尺度上同步深化——从场地关系到材料截面轮廓。我们借助实体模型、数字工具和材料样品对每个元素进行测试与精炼，然后将设计转化为精确、协调的施工文件。',
  ...
  studio_process_construction_tag: '阶段 04',
  ...
  studio_process_completion_tag: '阶段 05',
