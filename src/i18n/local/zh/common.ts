const translations = {
  ...
  studio_teaser_step5: '05 顾问协调',
  studio_teaser_step6: '06 施工',
  ...
  studio_process_discovery_title: '发现与咨询',
  studio_process_discovery_desc: '我们倾听并了解您的目标、需求和预算。',
  studio_process_discovery_tag: '阶段 01',
  studio_process_concept_title: '概念设计',
  studio_process_concept_desc: '我们探索理念、布局和项目的整体愿景。',
  studio_process_concept_tag: '阶段 02',
  studio_process_design_title: '设计深化',
  studio_process_design_desc: '经批准的概念被深化为详细且可建造的设计方案。',
  studio_process_design_tag: '阶段 03',
  studio_process_documentation_title: '技术文件',
  studio_process_documentation_desc: '我们编制施工所需的图纸和文件。',
  studio_process_documentation_tag: '阶段 04',
  studio_process_consultant_title: '顾问协调',
  studio_process_consultant_desc: '我们与工程师及其他专业顾问协调，确保各方工作协调统一。',
  studio_process_consultant_tag: '阶段 05',
  studio_process_construction_title: '施工支持',
  studio_process_construction_desc: '我们在整个施工过程中提供现场巡视、设计说明和技术指导。',
  studio_process_construction_tag: '阶段 06',
