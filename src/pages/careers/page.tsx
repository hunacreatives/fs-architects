...
export default function CareersPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      {/* ── HEADER ── */}
      <div className="w-full px-4 md:px-16 lg:px-24" style={{ paddingTop: '100px', paddingBottom: '40px' }}>
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <h1 style={{ fontFamily: 'Marcellus, serif', fontSize: 'clamp(32px, 4vw, 58px)', letterSpacing: '-0.03em', color: 'rgba(0,0,0,0.85)', lineHeight: 1.0, margin: 0, alignSelf: 'flex-start' }}>
            {t('careers_heading')}
          </h1>
      ...
      {/* ── APPLICATION FORM ── */}
      <div className="px-4 md:px-16 lg:px-24 mb-0">
